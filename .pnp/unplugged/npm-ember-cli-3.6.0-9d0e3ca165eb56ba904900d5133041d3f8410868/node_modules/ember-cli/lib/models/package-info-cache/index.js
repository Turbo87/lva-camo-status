...
class PackageInfoCache {
  ...
  loadProject(projectInstance) {
    ...
    logger.info('Reading package for project root: %o', projectInstance.root);
  ...
  loadAddon(addonInstance) {
    logger.trace('loadAddon(%j)', addonInstance.name);
  ...
  _readPackage(packageDir, pkg, isRoot) {
    logger.trace('_readPackage(%o, pkg, %o)', packageDir, isRoot);
    ...
    if (pkgInfo.isAddon()) {
      ...
      if (mainRealPath) {
        ...
        console.trace('main missing for', pkgInfo.name);
