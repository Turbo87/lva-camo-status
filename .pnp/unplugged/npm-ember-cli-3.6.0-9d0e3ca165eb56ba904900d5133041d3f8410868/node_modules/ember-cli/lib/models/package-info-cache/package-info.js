    ...
    dependencyNames.forEach(dependencyName => {
      ...
      if (!dependencyPackage) {
        ...
        if (pnp) {
          ...
          //
          // let pkgInfo = new PackageInfo(pkg, realPath, this.cache);
          // pkgInfo.nodeModules = require('./node-modules-list').NULL;
          //
          // this.cache._addEntry(realPath, pkgInfo);
          // dependencyPackage = this.cache._readPackage(realPath, pkg);
          dependencyPackage = this.cache._readPackage(realPath, undefined, undefined, true);

          // dependencyPackage = pkgInfo;
        }
      }
